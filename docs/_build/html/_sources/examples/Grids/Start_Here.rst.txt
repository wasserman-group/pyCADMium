...
- Creates a basic grid by specifying the number of points. Each grid depends on the number of radial/angular points that is multiplied by the number of points per block. 
